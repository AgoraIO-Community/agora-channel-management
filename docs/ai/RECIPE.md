...
Manage Agora RTC channel workflows such as joining, leaving, and coordinating participant state.

Use this recipe when you want a working reference for channel lifecycle, RTC, participant management, web app.

Repository: [AgoraIO-Community/agora-channel-management](https://github.com/AgoraIO-Community/agora-channel-management)
...
```text
You are working in `AgoraIO-Community/agora-channel-management`. Add or adapt this sample so a developer can run the channel management sample end to end with Agora RTC.
